naruto = {
	...
	atualiza:function(){
		this.cair() //faz o naruto cair

		/*
			se o naruto esta pisando no chão, zera o pulo e velocidade de queda 
	...
	*/
	...
	cair:function(){
		//o naruto é puxado pra baixo a todo momento
		this.velocidadeQueda += this.gravidade
		this.y += this.velocidadeQueda
	},

	//emprega força negativa na queda, o que faz o naruto pular
	pula:function(){
